...
module.exports = async (produto, tiny) => {
  ...
  schema.short_description = produto.descricao_complementar || produto.nome
  schema.body_text = produto.descricao_complementar
  ...
  schema.dimensions = {
    ...
    length: {
      value: parseFloat(produto.peso_liquido) || 0,
      unit: 'cm'
    }
  }
