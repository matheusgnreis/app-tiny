...
module.exports = (appSdk) => {
  logger.log('--> Start automatic stock control')
                        ...
                        produtos.forEach(async produto => {
                          ...
                          if (find && find.length) {
                            ...
                            if (qty !== saldo) {
                              ...
                              logger.log('Quantidade do produto %s atualizada para %i', sku, saldo)
                            }
                          } else {
                            // variation?
                            ...
                            if (qty !== saldo) {
                              ...
                              logger.log('Quantidade da variação %s atualizada %i', sku, saldo)
                            }
                          }
