...
module.exports = (appSdk) => {
  ...
  const fetchPedidosList = tiny => tiny.findOrders('08/10/2019', '09/10/2019')
    .then(result => {
                          ...
                          if (pedido) {
                            ...
                            ecomClient
                              ...
                              .then(({ data }) => {
                                ...
                                if (row[0].tiny_status.toLowerCase() !== TinySituacao(pedido.situacao).toLowerCase()) {
                                  options.method = 'post'
                                  options.data = {}
                                  let ecomStatus = data.financial_status.current
